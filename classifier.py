...
def train():
    ...
    num_pos_augmentations = 180
    num_neg_augmentations = 80
    x_train = []
    y_train = []
    num_extracted = 0

    print('Starting feature extraction.')
    print('Total number of positive samples after augmentation:', (num_pos_augmentations + 1) * len(positive_imgs))
    print('Total number of negative samples after augmentation:', (num_neg_augmentations + 1) * len(negative_imgs))
